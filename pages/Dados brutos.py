...
#Funcionalidade de Dowloand em CSV
@st.cache_data
def converte_csv(df):
...
with st.sidebar.expander('Data da compra'):
    data_compra = st.date_input('Selecione a data', value=(dados['Data da Compra'].min(), dados['Data da Compra'].max()))
...
#Criando a Funcionalidade de Filtragem
...
# Criando o botão de downloand do arquivo CSV
